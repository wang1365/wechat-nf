...
Page({
  data: {
    ...
    goodsDetail:{
      basicInfo: {
        ...
        commission: 6,
        commissionType: 1,
        numberOrders: Math.floor(Math.random() * 10),
        numberGoodReputation: Math.floor(Math.random() * 20)
      },
      
      pics: [{ pic: '../../images/sg/items/1.jpg' }, { pic: '../../images/sg/items/2.jpg' }, { pic:'../../images/sg/items/3.jpg'},]
    },
    swiperCurrent: 0,  
    hasMoreSelect:false,
    selectSize:"选择：",
    selectSizePrice: Math.floor(Math.random() * 10),
    totalScoreToPay: 0,
    shopNum:0,
    hideShopPopup:true,
    buyNumber:1,
  ...
  onLoad: function (e) {
    ...
    that.data.selectSizePrice=Math.floor(Math.random() * 10);
    var html = '<div id="fontzoom"><p> 　　5月21日，在国家现代<a href="http://sg.vegnet.com.cn/" target= "_blank" > 蔬菜 </a>种业创新创业基地研发中心的公共服务中心内，一瓶瓶蔬菜种子排放整齐，菜博会期间，每天前来参观学习的人络绎不绝。该研发中心的建设，为全国种业研发机构、种业企业提供了研发、交流、合作的平台。</p><p>　　种企强则种业强，目前，寿光市从事蔬菜育种的企业达到13家，其中6家单位获得市级以上种业技术研发中心认证，拥有自主知识产权的蔬菜新品种达到50个，正在申报农业部品种权保护的品种达到37个，黄瓜、圆茄、丝瓜、苦瓜等作物国产品种占有率达到85 % 以上，占比最高的黄瓜能达到95 %。</p></div>';
